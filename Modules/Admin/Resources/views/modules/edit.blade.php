...
@section('content')
    <div class="card" id="app">
        ...
        <ul role="tablist" class="nav nav-tabs">
            <li class="nav-item"><a href="/admin/modules" class="nav-link">模块列表</a></li>
            <li class="nav-item"><a href="#" class="nav-link active">修改模块</a></li>
        </ul>
        <form action="/admin/modules/{{$modules['id']}}" method="post">
