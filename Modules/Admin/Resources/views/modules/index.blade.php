    ...
    <div class="card" id="app">
        ...
        <div class="tab-container">
            <ul role="tablist" class="nav nav-tabs">
                <li class="nav-item"><a href="/admin/modules" class="nav-link active">模块列表</a></li>
                        ...
                        @foreach($data as $d)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    @endif
                                    <a href="/admin/modules/{{$d['id']}}/edit" class="btn btn-secondary">编辑</a>
                                    <button type="button" class="btn btn-secondary btn-danger"
                                            onclick="del({{$d['id']}},this)">删除
                                    </button>
                                    <form action="/admin/modules/{{$d['id']}}" hidden method="post">
                                        @csrf @method('DELETE')
                                    </form>
                                </td>
                            </tr>
