...
@section('content')
    <div class="card" id="app">
        ...
        <ul role="tablist" class="nav nav-tabs">
            <li class="nav-item"><a href="/wx/wx_config" class="nav-link">微信基本配置列表</a></li>
            <li class="nav-item"><a href="#" class="nav-link active">修改微信基本配置</a></li>
        </ul>
        <form action="/wx/wx_config/{{$wx_config['id']}}" method="post">
            <div class="card-body card-body-contrast">
                @csrf @method('PUT')
                <div class="form-group row">
    <label for="name" class="col-12 col-sm-3 col-form-label text-md-right">配置名称</label>
